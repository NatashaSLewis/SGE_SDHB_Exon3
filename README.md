...
The following analysis steps require **Python 3.9** for pileup and **Python 3.6** for remaining steps.

## General Requirements

Create and activate a Python environment before running Step 2.
...
Create and activate a Python environment before running Steps 3–6.
